...
export function CardHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("flex items-start justify-between gap-4 border-b border-border/80 px-[var(--density-card-header-x)] py-[var(--density-card-header-y)]", className)} {...props} />;
}
