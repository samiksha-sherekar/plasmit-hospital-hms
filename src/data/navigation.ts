...
export const navigationItems: NavigationItem[] = [
  ...
  // { id: "pharmacist-drug-dispense-history", label: "Drug Dispense History", icon: History, route: "/pharmacist/drug-dispense-history", group: "Pharmacist", allowedRoles: ["Pharmacist"], status: "ready" },
  {
    ...
    label: "Masters",
    icon: Pill,
    route: "/pharmacist/masters/drug-master",
    group: "pharmacist",
    allowedRoles: ["Pharmacist"],
    status: "ready",
    children: [
      { id: "pharmacy-drug-category", label: "Drug Category", route: "/pharmacist/masters/drug-category", status: "ready" },
      { id: "pharmacy-drug-sub-category", label: "Drug Sub Category", route: "/pharmacist/masters/drug-sub-category", status: "ready" },
      { id: "pharmacy-drug-master", label: "Drug Master", route: "/pharmacist/masters/drug-master", status: "ready" },
      { id: "pharmacy-supplier-master", label: "Supplier Master", route: "/pharmacist/masters/supplier-master", status: "ready" },
      { id: "pharmacy-manufacturer-master", label: "Manufacturer Master", route: "/pharmacist/masters/manufacturer-master", status: "ready" },
      { id: "pharmacy-unit-master", label: "Unit Master", route: "/pharmacist/masters/unit-master", status: "ready" },
      { id: "pharmacy-rack-store-location", label: "Rack / Store Location", route: "/pharmacist/masters/rack-store-location", status: "ready" },
    ],
  },
  {
    ...
    label: "Inventory",
    icon: Store,
    route: "/pharmacist/inventory/current-stock",
    group: "pharmacist",
    allowedRoles: ["Pharmacist"],
    status: "ready",
    children: [
      { id: "pharmacy-current-stock", label: "Current Stock", route: "/pharmacist/inventory/current-stock", status: "ready" },
      { id: "pharmacy-batch-stock", label: "Batch Stock", route: "/pharmacist/inventory/batch-stock", status: "ready" },
      { id: "pharmacy-expiry-tracking", label: "Expiry Tracking", route: "/pharmacist/inventory/expiry-tracking", status: "ready" },
      { id: "pharmacy-stock-adjustment", label: "Stock Adjustment", route: "/pharmacist/inventory/stock-adjustment", status: "ready" },
      { id: "pharmacy-stock-transfer", label: "Stock Transfer", route: "/pharmacist/inventory/stock-transfer", status: "ready" },
    ],
  },
  {
    ...
    label: "Purchase",
    icon: Package,
    route: "/pharmacist/purchase/requisition",
    group: "pharmacist",
    allowedRoles: ["Pharmacist"],
    status: "ready",
    children: [
      { id: "pharmacy-purchase-requisition", label: "Purchase Requisition", route: "/pharmacist/purchase/requisition", status: "ready" },
      { id: "pharmacy-purchase-order", label: "Purchase Order", route: "/pharmacist/purchase/order", status: "ready" },
      { id: "pharmacy-grn", label: "Goods Receipt Note (GRN)", route: "/pharmacist/purchase/grn", status: "ready" },
      { id: "pharmacy-purchase-return", label: "Purchase Return", route: "/pharmacist/purchase/return", status: "ready" },
    ],
  },
  // {
