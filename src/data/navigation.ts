...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    label: "Approvals",
    icon: CheckCircle2,
    route: "/pharmacy/approvals/purchase-requisition",
    group: "Pharmacy",
    allowedRoles: ["Super Admin", "Hospital Admin", "Pharmacist", "Management"],
    status: "ready",
    children: [
      { id: "pharmacy-pr-approval", label: "Purchase Requisition Approval", route: "/pharmacy/approvals/purchase-requisition", status: "ready" },
      { id: "pharmacy-stock-adjustment-approval", label: "Stock Adjustment Approval", route: "/pharmacy/approvals/stock-adjustment", status: "ready" },
      { id: "pharmacy-stock-transfer-approval", label: "Stock Transfer Approval", route: "/pharmacy/approvals/stock-transfer", status: "ready" },
      { id: "pharmacy-purchase-return-approval", label: "Purchase Return Approval", route: "/pharmacy/approvals/purchase-return", status: "ready" },
    ],
  },
  // {
