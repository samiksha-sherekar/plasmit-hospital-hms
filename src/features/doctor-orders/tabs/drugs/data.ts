...
export const initialOrders: DrugOrder[] = [
  ...
  { id: "drug-010", category: "Intermittent", genericName: "Ceftriaxone", name: "Ceftriaxone IV Infusion", form: "Infusion", dosage: "1", doseUnit: "gram", maxDosage: "", frequency: "Intermittent", days: "5", route: "Intravenous (IV)", availableQty: 26, pharmacy: "Emergency pharmacy", startDate: "2026-06-05", endDate: "", instructions: "Infuse over 30 minutes", orderedQty: 5, dispensedQty: 0, receivedQty: 0, administeredQty: 0, diluents: ["Normal Saline", "Dextrose"] },
];
